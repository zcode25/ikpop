...
<body>
    ...
    <div id="preloader" class="align-self-center">
        <img class="preloader-img" src="img/iKPOP.png" alt="" width="70px">
    </div>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <div class="navbar-nav">
                    ...
                    <a class="nav-link" href="https://www.instagram.com/ikpop25/" target="_blank">Follow Us</a>
                    <a class="nav-link" href="https://sociabuzz.com/azein25/donate" target="_blank">Donate</a>
                </div>
